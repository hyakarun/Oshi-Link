      ...
      <DialogContent className="max-w-md p-8 border-none rounded-[32px] bg-white shadow-2xl">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="flex gap-3 w-full mt-4">
            <Button onClick={onClose} className="flex-1 bg-gray-100 text-gray-600 h-12 rounded-2xl font-black hover:bg-gray-200 shadow-sm active:scale-95 transition-all">キャンセル</Button>
            <a 
              href={url || '#'} 
              target="_blank" 
