...
// .wrangler/tmp/pages-aFjIOT/bundledWorker-0.9513822237077947.mjs
...
async function X(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let o = globalThis[xe], n = /* @__PURE__ */ __name2(async () => {
          let i = await e.json();
...
function ye() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return s || (s = await X(r), s) ? s : (we(r), e(r));
  };
}
__name(ye, "ye");
__name2(ye, "ye");
