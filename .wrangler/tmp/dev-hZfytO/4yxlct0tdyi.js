...
// .wrangler/tmp/pages-1Ka7jd/bundledWorker-0.419617673444008.mjs
...
var Ns = { async fetch(e, t, r) {
  ...
  return a.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: T }, async () => o.run({ env: t, ctx: r, cf: e.cf }, async () => {
    if (new URL(e.url).pathname.startsWith("/_next/image")) return z(e, { buildOutput: f, assetsFetcher: t.ASSETS, imagesConfig: _.images });
    let i = G(e);
...
// .wrangler/tmp/pages-1Ka7jd/4yxlct0tdyi.js
...
// .wrangler/tmp/bundle-xjoexy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xjoexy/middleware-loader.entry.ts
 ...
 * MIT Licensed
 */
//# sourceMappingURL=4yxlct0tdyi.js.map
