...
Navigation & Group Management: Discord-like sidebar for switching between different "Oshi" groups.

Event Detail Cards: Airbnb-style clean cards with integrated maps and clear call-to-action buttons.

Trust & Verification: X (Twitter) Community Notes style for crowdsourced data verification and source linking.

Overall Aesthetic: shadcn/ui "Modern SaaS" look, focusing on high density yet clean typography.
